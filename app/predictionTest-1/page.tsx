...
const HeartHealthForm = () => {
  ...
  const formSteps = [
    ...
    <motion.div 
      ...
      className="space-y-6"
    >
      <motion.h2 variants={formVariants} className="text-2xl font-bold text-green-800 mb-6">Basic Information</motion.h2>
    ...
    <motion.div 
      ...
      className="space-y-6"
    >
      <motion.h2 variants={formVariants} className="text-2xl font-bold text-green-800 mb-6">Blood Readings</motion.h2>
    ...
    <motion.div 
      ...
      className="space-y-6"
    >
      <motion.h2 variants={formVariants} className="text-2xl font-bold text-green-800 mb-6">Heart Readings</motion.h2>
    ...
    <motion.div 
      ...
      className="space-y-6"
    >
      <motion.h2 variants={formVariants} className="text-2xl font-bold text-green-800 mb-6">Additional Information</motion.h2>
